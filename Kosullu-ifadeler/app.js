...
// x= '20'-'12';
// console.log(x); // 8 çıktı

// // ASCII tablosuna göre stringlerin bir değeri vardır.

// x = "A".charCodeAt(0);
// console.log(x);

// comma operatörünü detaylı bak
// let x = (y=5 , z=6);
// console.log(x); // 6 döndü virgül ensondaki değeri döndürür.

// const number = prompt('enter a number : ');
// if (number>0){
//     console.log("sayı sıfırdan büyüktür");
// } else {
